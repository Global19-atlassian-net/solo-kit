...
var (
	NoKubeNamespaceClientForClusterError = func(cluster string) error {
		return errors.Errorf("kubernetes.KubeNamespace client not found for cluster %v", cluster)
	}
)
...
func (c *kubeNamespaceMultiClusterClient) interfaceFor(cluster string) (KubeNamespaceInterface, error) {
	...
	return nil, NoKubeNamespaceClientForClusterError(cluster)
}
